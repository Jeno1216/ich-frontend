...
<p className='people-name m-0' style={{fontWeight: '600', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', width: '160px'}} key={`name-${user._id}`}>{user.username}</p>
