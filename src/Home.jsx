...
<div id='expectation' className='p-lg-5 p-md-5 p-2 d-flex justify-content-center align-items-center'>
  <div data-aos="fade-up" className='container p-3 d-flex justify-content-center flex-column align-items-center border rounded-2 mt-5 mb-5 shadow' style={{backdropFilter: 'blur(15px)'}}>
    <div className='mb-3'>
...
<div className=' p-lg-4 p-md-4 p-2 d-flex justify-content-center align-items-center'>
  <div className=' row col-12  d-flex justify-content-lg-start justify-content-md-start justify-content-center'>

  {
    posts.sort((a, b) => b.averageRating - a.averageRating) // sort posts by average rating in descending order
...
<div className=' p-lg-4 p-md-4 p-2 d-flex justify-content-center align-items-center'>
  ...
  {
    posts.sort((a, b) => b.numberOfRatings - a.numberOfRatings) // sort posts by number of ratings in descending order
    .slice(0, 4) // get the top 4 posts
    .map(post => ( // loops all instances
    <div className='col-lg-3 col-md-4 col-sm-5 col-6 p-lg-2 p-md-2 p-2'>
      <div className='border shadow rounded-3 p-2' style={{backdropFilter:'blur(15px)'}}>
